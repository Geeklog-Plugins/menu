...
function MENU_displayMenuList( ) {
    global $_CONF, $LANG_MENU00, $LANG_MENU01, $LANG_MENU_ADMIN, $LANG_ADMIN, $LANG_MENU_MENU_TYPES, $_MENU_CONF, $Menus;
    ...
    $T = new Template($_CONF['path'] . 'plugins/menu/templates/');
...
function MENU_displayTree( $menu_id ) {
    global $_CONF, $LANG_MENU00, $LANG_MENU01, $LANG_MENU_ADMIN, $LANG_ADMIN, $_MENU_CONF, $Menus,$_SCRIPTS;
...
function MENU_createElement ( $menu_id ) {
    global $_CONF, $_TABLES, $_MENU_CONF, $Menus, $LANG_MENU00, $LANG_MENU01, $LANG_MENU_ADMIN, $LANG_MENU_TYPES,
           $LANG_MENU_GLTYPES, $LANG_MENU_GLFUNCTION, $_SCRIPTS, $_PLUGINS;
...
function MENU_editElement( $menu_id, $mid ) {
    global $_CONF, $_TABLES, $_MENU_CONF, $Menus,$Menus,$LANG_MENU00, $LANG_MENU01, $LANG_MENU_ADMIN,
           $LANG_MENU_TYPES, $LANG_MENU_GLTYPES, $LANG_MENU_GLFUNCTION, $_SCRIPTS, $_PLUGINS;
...
function MENU_saveEditMenuElement ( ) {
    ...
    $label         = htmlspecialchars(strip_tags(COM_checkWords(COM_stripslashes($_POST['menulabel']))));
...
function MENU_menuConfig( $mid ) {
    global $_CONF, $_TABLES, $_MENU_CONF, $Menus, $LANG_MENU00, $LANG_MENU01, $LANG_MENU_ADMIN,
...
if ( (isset($_POST['execute']) || $mode != '') && !isset($_POST['cancel']) && !isset($_POST['defaults'])) {
    switch ( $mode ) {
        ...
        case 'editmenu' :
            ...
            break;
        case 'activate' :
            MENU_changeActiveStatusElement ($_POST['enableditem']);
            MENU_initMENU();
            $content = MENU_displayTree( $menu_id );
            $currentSelect = $LANG_MENU01['menu_builder'];
            break;
        case 'menuactivate' :
            MENU_changeActiveStatusMenu ($_POST['enabledmenu']);
            MENU_initMENU();
            $content = MENU_displayMenuList( );
            $currentSelect = $LANG_MENU01['menu_builder'];
            break;
        ...
        case 'deletemenu' :
            ...
            echo COM_refresh($_CONF['site_admin_url'] . '/plugins/menu/index.php');
            exit;
            break;
        case 'config' :
        ...
        case 'disablemenu' :
            ...
            DB_query($sql);
            echo COM_refresh($_CONF['site_admin_url'] . '/plugins/menu/index.php?mode=menu&amp;mid=' . $mid);
            exit;
            break;
        case 'menucolor' :
            $content = MENU_menuConfig($menu_id);
...
if (function_exists('COM_createHTMLDocument')) {
    ...
    COM_output( COM_siteHeader('menu') . $display . COM_siteFooter() );
}
